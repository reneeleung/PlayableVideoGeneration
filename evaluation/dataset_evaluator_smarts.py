...
class DatasetEvaluatorSmarts(DatasetEvaluator):
    '''
    ...
    def __init__(self, config, logger, reference_dataset: VideoDataset, generated_dataset: VideoDataset):
        ...
        super(DatasetEvaluatorSmarts, self).__init__(config, logger, reference_dataset, generated_dataset)
    ...
    def compute_metrics(self) -> Dict:
        ...
        with torch.no_grad():
            for idx, (reference_batch, generated_batch) in enumerate(zip(self.reference_dataloader, self.generated_dataloader)):
                ...
                # Reconstructs the positions of the track
                #TODO detector for track relative to ego center
