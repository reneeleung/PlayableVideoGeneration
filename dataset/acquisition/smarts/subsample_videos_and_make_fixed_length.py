...
root_directories = ["tmp/smarts_v4_256_ours/test", "tmp/smarts_v4_256_ours/validation"]
output_directories = ["tmp/smarts_v4_256_ours/test_fixed_length", "tmp/smarts_v4_256_ours/val_fixed_length"]
frame_skip = 0
sequence_length = 16
extension = "png"
